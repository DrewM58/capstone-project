...
The second assessment is an overall teacher judgement (OTJ) of student progress and achievement up to a particular point in time, made using the National Standards. National Standards are a national benchmark for student progress. Teachers use a range of evidence of student achievement to judge whether a student is 'At', 'Below', or 'Above' the expected National Standard. For this analysis we will use the mathematics National Standards OTJ from the end of Year 4.
